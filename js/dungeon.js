...
function advanceRoom(){
  currentRoom++;updateRoomDisplay();createEnemy(currentRoom);healBetweenRooms();resetBoard();resetState();setCombatMessage(`Sala ${currentRoom}: ${enemy.maxHealth} HP · ${enemy.attackDamage} daño.`)
}
